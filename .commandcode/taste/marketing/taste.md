...
- Prefers "support" wording over "sponsor" for the funding/donation link and CTA — explicitly asked to remove "Sponsor" and use "Support" so it matches the navbar's existing "Support Project" label; "sponsor" is treated as off-brand for a privacy-focused open-source product. Confidence: 0.5
